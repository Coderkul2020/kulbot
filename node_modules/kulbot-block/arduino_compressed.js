...
return"void "+b+"("+c.join(", ")+")"};Blockly.Arduino.argument_reporter_boolean=function(a){a=a.getFieldValue("VALUE");return[Blockly.Arduino.customFunctionsArgName_[a],Blockly.Arduino.ORDER_ATOMIC]};Blockly.Arduino.argument_reporter_number=function(a){a=a.getFieldValue("VALUE");return[Blockly.Arduino.customFunctionsArgName_[a],Blockly.Arduino.ORDER_ATOMIC]};Blockly.Arduino.argument_reporter_string=function(a){a=a.getFieldValue("VALUE");return[Blockly.Arduino.customFunctionsArgName_[a],Blockly.Arduino.ORDER_ATOMIC]};Blockly.Arduino.suny={};Blockly.Arduino.event_whenkulbotbegin=function(){Blockly.Arduino.includes_.arduino_1="#include <Arduino.h>";Blockly.Arduino.includes_.include_suny="#include <Suny.h>\nSuny Rob;\n";Blockly.Arduino.setups_.setups_int="Rob.Init();";return""};
Blockly.Arduino.arduino_pin_esp32ledOnOF=function(a){a=Blockly.Arduino.valueToCode(a,"LEVEL",Blockly.Arduino.ORDER_UNARY_POSTFIX)||"LOW";Blockly.Arduino.includes_.include_suny="#include <Suny.h>\nSuny Rob;\n";Blockly.Arduino.setups_.setups_int="Rob.Init();";switch(a){case "HIGH":var b='Rob.SetAllLed("R");\n';break;case "LOW":b="Rob.TurnOFFALL();\n "}return b};
Blockly.Arduino.arduino_pin_eps32SUltra=function(a){a=a.getFieldValue("PIN")||"0";Blockly.Arduino.includes_.include_suny="#include <Suny.h>\nSuny Rob;\n";Blockly.Arduino.setups_.setups_int="Rob.Init();\n";return["Rob.getSonarValue("+a+")",Blockly.Arduino.ORDER_ATOMIC]};
Blockly.Arduino.arduino_pin_eps32STemp=function(a){a=a.getFieldValue("PIN")||"0";Blockly.Arduino.includes_.include_suny="#include <Suny.h>\nSuny Rob;\n";Blockly.Arduino.setups_.setups_int="Rob.Init();\n";return["Rob.getTempertatureValue("+a+")",Blockly.Arduino.ORDER_ATOMIC]};
Blockly.Arduino.arduino_pin_eps32SDHT11=function(a){var b=a.getFieldValue("PIN")||"1";a=a.getFieldValue("FUN")||"0";Blockly.Arduino.includes_.include_suny="#include <Suny.h>\nSuny Rob;\n";Blockly.Arduino.setups_.setups_int="Rob.Init();\n";return["Rob.getDHT11Value("+b+","+a+")",Blockly.Arduino.ORDER_ATOMIC]};
Blockly.Arduino.arduino_pin_eps32SDHT12=function(a){var b=a.getFieldValue("PIN")||"1";a=a.getFieldValue("FUN")||"0";Blockly.Arduino.includes_.include_suny="#include <Suny.h>\nSuny Rob;\n";Blockly.Arduino.setups_.setups_int="Rob.Init();\nRob.Suny_DHT12_Init();\n";return["Rob.getDHT12("+b+","+a+")",Blockly.Arduino.ORDER_ATOMIC]};
Blockly.Arduino.arduino_pin_eps32STouch=function(a){a=a.getFieldValue("PIN")||"0";Blockly.Arduino.includes_.include_suny="#include <Suny.h>\nSuny Rob;\n";Blockly.Arduino.setups_.setups_int="Rob.Init();\n";return["Rob.getTouchLedPCF("+a+")",Blockly.Arduino.ORDER_ATOMIC]};
Blockly.Arduino.arduino_pin_eps32STouchLed=function(a){var b=a.getFieldValue("PIN")||"1";a=a.getFieldValue("CLINE")||"R";Blockly.Arduino.includes_.include_suny="#include <Suny.h>\nSuny Rob;\n";Blockly.Arduino.setups_.setups_int="Rob.Init();\n";return"Rob.SetTouchLedPCF("+b+","+a+");\n"};
Blockly.Arduino.arduino_pin_eps32SLine=function(a){var b=a.getFieldValue("PIN")||"0";a=a.getFieldValue("VLE")||"0";Blockly.Arduino.includes_.include_suny="#include <Suny.h>\nSuny Rob;\n";Blockly.Arduino.setups_.setups_int="Rob.Init();\n";return["Rob.getLinePCF("+b+","+a+")",Blockly.Arduino.ORDER_ATOMIC]};
Blockly.Arduino.arduino_pin_eps32SIR=function(a){a=a.getFieldValue("PIN")||"0";Blockly.Arduino.includes_.include_suny="#include <Suny.h>\nSuny Rob;\n";Blockly.Arduino.setups_.setups_int="Rob.Init();\n";return["Rob.getIRPCF("+a+")",Blockly.Arduino.ORDER_ATOMIC]};
Blockly.Arduino.arduino_pin_eps32SIRLed=function(a){var b=a.getFieldValue("PIN")||"1",c=a.getFieldValue("VLE")||"0";a=a.getFieldValue("CLINE")||"R";Blockly.Arduino.includes_.include_suny="#include <Suny.h>\nSuny Rob;\n";Blockly.Arduino.setups_.setups_int="Rob.Init();\n";return"Rob.setIRPCFLed("+b+","+c+","+a+");\n"};
Blockly.Arduino.arduino_pin_eps32traLED=function(a){var b=a.getFieldValue("PIN")||"1",c=a.getFieldValue("VLE")||"R";a=a.getFieldValue("CLINE")||"NONE";Blockly.Arduino.includes_.include_suny="#include <Suny.h>\nSuny Rob;\n";Blockly.Arduino.setups_.setups_int="Rob.Init();\n";return"Rob.SetTracficLigt("+b+',"'+c+'","'+a+'");\n'};
Blockly.Arduino.arduino_pin_eps32SMotorM1=function(a){var b=a.getFieldValue("MO")||"1",c=a.getFieldValue("MoFB")||"0";a=Blockly.Arduino.valueToCode(a,"OUT",Blockly.Arduino.ORDER_UNARY_POSTFIX)||0;Blockly.Arduino.includes_.include_suny="#include <Suny.h>\nSuny Rob;\n";Blockly.Arduino.setups_.setups_int="Rob.Init();\n";return"Rob.Motor1("+b+","+a+","+c+"); \n"};
Blockly.Arduino.arduino_pin_eps32SServo=function(a){var b=a.getFieldValue("PIN")||"1";a=Blockly.Arduino.valueToCode(a,"OUT",Blockly.Arduino.ORDER_UNARY_POSTFIX)||0;Blockly.Arduino.includes_.include_suny="#include <Suny.h>\nSuny Rob;\n";Blockly.Arduino.setups_.setups_int="Rob.Init();\n";return"Rob.Servo("+b+","+a+");\n"};
Blockly.Arduino.arduino_serial_esp32serialBegin=function(a){a=a.getFieldValue("VALUE")||"9600";Blockly.Arduino.includes_.include_suny="#include <Suny.h>\nSuny Rob;\n";Blockly.Arduino.setups_.setups_int="Rob.Init();\n";return"Serial.begin("+a+");\n"};
Blockly.Arduino.arduino_serial_esp32serialPrint=function(a){var b=Blockly.Arduino.valueToCode(a,"VALUE",Blockly.Arduino.ORDER_UNARY_POSTFIX)||"";a=a.getFieldValue("EOL")||"warp";Blockly.Arduino.includes_.include_suny="#include <Suny.h>\nSuny Rob;\n";Blockly.Arduino.setups_.setups_int="Rob.Init();\n";return"warp"===a?"Serial.println("+b+");\n":"Serial.print("+b+");\n"};
Blockly.Arduino.arduino_serial_esp32serialAvailable=function(){Blockly.Arduino.includes_.include_suny="#include <Suny.h>\nSuny Rob;\n";Blockly.Arduino.setups_.setups_int="Rob.Init();\n";return["Serial.available()",Blockly.Arduino.ORDER_ATOMIC]};Blockly.Arduino.arduino_serial_esp32serialReadData=function(){Blockly.Arduino.includes_.include_suny="#include <Suny.h>\nSuny Rob;\n";Blockly.Arduino.setups_.setups_int="Rob.Init();\n";return["Serial.read()",Blockly.Arduino.ORDER_ATOMIC]};
Blockly.Arduino.arduino_serial_esp32multiSerialBegin=function(a){var b=a.getFieldValue("NO")||"0";a=a.getFieldValue("VALUE")||"9600";Blockly.Arduino.includes_.include_suny="#include <Suny.h>\nSuny Rob;\n";Blockly.Arduino.setups_.setups_int="Rob.Init();\n";"0"===b&&(b="");return"Serial"+b+".begin("+a+");\n"};
Blockly.Arduino.arduino_serial_esp32multiSerialPrint=function(a){var b=a.getFieldValue("NO")||"0";a=Blockly.Arduino.valueToCode(a,"VALUE",Blockly.Arduino.ORDER_UNARY_POSTFIX)||"";Blockly.Arduino.includes_.include_suny="#include <Suny.h>\nSuny Rob;\n";Blockly.Arduino.setups_.setups_int="Rob.Init();\n";"0"===b&&(b="");return"Serial"+b+".println("+a+");\n"};
Blockly.Arduino.arduino_serial_esp32multiSerialAvailable=function(a){a=a.getFieldValue("NO")||"0";Blockly.Arduino.includes_.include_suny="#include <Suny.h>\nSuny Rob;\n";Blockly.Arduino.setups_.setups_int="Rob.Init();\n";"0"===a&&(a="");return["Serial"+a+".available()",Blockly.Arduino.ORDER_ATOMIC]};
Blockly.Arduino.arduino_serial_esp32multiSerialReadAByte=function(a){a=a.getFieldValue("NO")||"0";Blockly.Arduino.includes_.include_suny="#include <Suny.h>\nSuny Rob;\n";Blockly.Arduino.setups_.setups_int="Rob.Init();\n";"0"===a&&(a="");return["Serial"+a+".read()",Blockly.Arduino.ORDER_ATOMIC]};Blockly.Arduino.arduino_sensor_esp32runningTime=function(){Blockly.Arduino.includes_.include_suny="#include <Suny.h>\nSuny Rob;\n";Blockly.Arduino.setups_.setups_int="Rob.Init();\n";return["millis()",Blockly.Arduino.ORDER_ATOMIC]};
Blockly.Arduino.arduino_data_esp32dataMap=function(a){var b=Blockly.Arduino.valueToCode(a,"DATA",Blockly.Arduino.ORDER_UNARY_POSTFIX)||0,c=Blockly.Arduino.valueToCode(a,"ARG0",Blockly.Arduino.ORDER_UNARY_POSTFIX)||1,d=Blockly.Arduino.valueToCode(a,"ARG1",Blockly.Arduino.ORDER_UNARY_POSTFIX)||100,e=Blockly.Arduino.valueToCode(a,"ARG2",Blockly.Arduino.ORDER_UNARY_POSTFIX)||1;a=Blockly.Arduino.valueToCode(a,"ARG3",Blockly.Arduino.ORDER_UNARY_POSTFIX)||1E3;Blockly.Arduino.includes_.include_suny="#include <Suny.h>\nSuny Rob;\n";
Blockly.Arduino.setups_.setups_int="Rob.Init();\n";return["map("+b+", "+c+", "+d+", "+e+", "+a+")",Blockly.Arduino.ORDER_ATOMIC]};
Blockly.Arduino.arduino_data_esp32dataConstrain=function(a){var b=Blockly.Arduino.valueToCode(a,"DATA",Blockly.Arduino.ORDER_UNARY_POSTFIX)||0,c=Blockly.Arduino.valueToCode(a,"ARG0",Blockly.Arduino.ORDER_UNARY_POSTFIX)||1;a=Blockly.Arduino.valueToCode(a,"ARG1",Blockly.Arduino.ORDER_UNARY_POSTFIX)||100;Blockly.Arduino.includes_.include_suny="#include <Suny.h>\nSuny Rob;\n";Blockly.Arduino.setups_.setups_int="Rob.Init();\n";return["constrain("+b+", "+c+", "+a+")",Blockly.Arduino.ORDER_ATOMIC]};
Blockly.Arduino.arduino_data_esp32dataConvert=function(a){var b=Blockly.Arduino.valueToCode(a,"DATA",Blockly.Arduino.ORDER_UNARY_POSTFIX)||0;a=a.getFieldValue("TYPE")||"WHOLE_NUMBER";Blockly.Arduino.includes_.include_suny="#include <Suny.h>\nSuny Rob;\n";Blockly.Arduino.setups_.setups_int="Rob.Init();\n";switch(a){case "WHOLE_NUMBER":var c="String("+b+").toInt()";break;case "DECIMAL":c="String("+b+").toFloat()";break;case "STRING":c="String("+b+")"}return[c,Blockly.Arduino.ORDER_ATOMIC]};
Blockly.Arduino.arduino_data_esp32dataConvertASCIICharacter=function(a){a=Blockly.Arduino.valueToCode(a,"DATA",Blockly.Arduino.ORDER_UNARY_POSTFIX)||"0";Blockly.Arduino.includes_.include_suny="#include <Suny.h>\nSuny Rob;\n";Blockly.Arduino.setups_.setups_int="Rob.Init();\n";return["String(char("+a+"))",Blockly.Arduino.ORDER_ATOMIC]};
Blockly.Arduino.arduino_data_esp32dataConvertASCIINumber=function(a){a=Blockly.Arduino.valueToCode(a,"DATA",Blockly.Arduino.ORDER_UNARY_POSTFIX)||"0";Blockly.Arduino.includes_.include_suny="#include <Suny.h>\nSuny Rob;\n";Blockly.Arduino.setups_.setups_int="Rob.Init();\n";return["toascii(String("+a+")[0])",Blockly.Arduino.ORDER_ATOMIC]};
Blockly.Arduino.arduino_pin_eps32SMotorM1H=function(a){var b=a.getFieldValue("MO")||"1",c=a.getFieldValue("MoFB")||"0";a=a.getFieldValue("OUT")||"0";Blockly.Arduino.includes_.include_suny="#include <Suny.h>\nSuny Rob;\n";Blockly.Arduino.setups_.setups_int="Rob.Init();\n";return"Rob.Motor1("+b+","+a+","+c+"); \n"};Blockly.Arduino.texts={};Blockly.Arduino.text=function(a){return[Blockly.Arduino.quote_(a.getFieldValue("TEXT")),Blockly.Arduino.ORDER_ATOMIC]};
